export function BookDetailSkeleton({ label = "Cargando detalle del libro" }) {
  return (
    <div role="status" aria-label={label} className="grid gap-7 md:grid-cols-[minmax(12rem,17rem)_minmax(0,1fr)] md:gap-8 xl:grid-cols-[minmax(14rem,20rem)_minmax(0,1fr)] xl:gap-12">
